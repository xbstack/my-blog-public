import { S as ROUTE_TYPE_HEADER, T as REROUTE_DIRECTIVE_HEADER, P as DEFAULT_404_COMPONENT, j as AstroError, V as ActionNotFoundError, W as clientAddressSymbol, X as LocalsNotAnObject, Y as FailedToFindPageMapSSR, Z as REROUTABLE_STATUS_CODES, _ as responseSentSymbol, $ as nodeRequestAbortControllerCleanupSymbol } from './astro/server_CVKVJgiO.mjs';
import colors from 'piccolore';
import 'clsx';
import { D as DEFAULT_404_ROUTE, d as default404Instance, e as ensure404Route } from './astro-designed-error-pages_BPqeOYf7.mjs';
import 'es-module-lexer';
import buffer from 'node:buffer';
import crypto from 'node:crypto';
import fs, { createReadStream, existsSync, readFileSync } from 'node:fs';
import { Http2ServerResponse } from 'node:http2';
import { f as fileExtension, j as joinPaths, s as slash, p as prependForwardSlash$1, c as removeTrailingForwardSlash, d as appendForwardSlash, e as isInternalPath, g as collapseDuplicateTrailingSlashes, h as hasFileExtension } from './path_CpYqPZEY.mjs';
import { m as matchPattern } from './remote_DVMROsal.mjs';
import { r as requestIs404Or500, i as isRequestServerIsland, n as notFound, a as normalizeTheLocale, b as redirectToFallback, c as redirectToDefaultLocale, d as requestHasLocale, e as defineMiddleware, S as SERVER_ISLAND_COMPONENT, f as SERVER_ISLAND_ROUTE, g as createEndpoint, R as RouteCache, s as sequence, h as findRouteToRewrite, v as validateAndDecodePathname, m as matchRoute, j as RenderContext, P as PERSIST_SYMBOL, k as getSetCookiesFromResponse } from './render-context_CfIkCxhM.mjs';
import { N as NOOP_MIDDLEWARE_FN } from './noop-middleware_D4H3TJkk.mjs';
